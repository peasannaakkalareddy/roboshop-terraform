...
#  source = "git::https://github.com/peasannaakkalareddy/tf-module-app.git"
#
#  for_each          = var.app
...
module "rds" {
  source = "git::https://github.com/peasannaakkalareddy/tf-module-rds.git"
...
module "elasticache" {
  source = "git::https://github.com/peasannaakkalareddy/tf-module-elasticache.git"
...
module "rabbitmq" {
  source = "git::https://github.com/peasannaakkalareddy/tf-module-amazon-mq.git"
...
#module "alb" {
#  source = "git::https://github.com/peasannaakkalareddy/tf-module-alb.git"
#
#  for_each       = var.alb
#  subnets        = lookup(lookup(lookup(lookup(module.vpc, "main", null), "subnets", null), each.value["subnet_name"], null), "subnet_ids", null)
...
#  vpc_security_group_ids = ["sg-0266fc3fc1e7aea54"]
#  tags = {
#    Name = "load-runner"
#  }
#}
...
#
module "eks" {
  source             = "git::https://github.com/peasannaakkalareddy/tf-module-eks.git"
  ENV                = var.env
  eks_version        = 1.27
